"""A Python script to move all .jpg files from a source folder to a new folder"""
...
def move_jpg_files(source_folder,destination_folder):
    ...
    # Create destination folder if it does'nt exist
...
def main():
    ...
    source_folder = "D:\source"    # Please enter your source address
    destination_folder = "D:\jpg_files"  # Please enter your destination address where to want to shift them
